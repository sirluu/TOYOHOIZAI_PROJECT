...
const validateRegisterInput = require('../../controller/user/register');
const validateLoginInput = require('../../controller/user/login');
const validateUpdateUserInput = require('../../controller/user/updateUser');
