...
export default function TopNavigation() {
  ...
  return (
    <nav className="h-16 hidden lg:flex items-center justify-between px-6 py-8 bg-primaryBlack w-full fixed top-0 left-0 z-50 text-primaryWhite lg:py-11 transition-all ease-in-out">
